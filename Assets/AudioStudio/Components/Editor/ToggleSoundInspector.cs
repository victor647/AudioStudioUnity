...
namespace AudioStudio.Editor
{
    ...
    public class ToggleSoundInspector : AsComponentInspector
    {
        ...
        private void AddOnEvent(Object[] objects)
        {
            ...
            {
                AsScriptingHelper.AddToArray(ref _component.ToggleOnEvents, new PostEventReference(evt.name));
            }
        }
        ...
        private void AddOffEvent(Object[] objects)
        {
            ...
            foreach (var evt in events)
            {
                AsScriptingHelper.AddToArray(ref _component.ToggleOffEvents, new PostEventReference(evt.name));
            }
        }
