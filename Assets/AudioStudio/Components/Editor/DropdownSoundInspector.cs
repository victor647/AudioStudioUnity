...
namespace AudioStudio.Editor
{
    ...
    public class DropdownSoundInspector : AsComponentInspector
    {
        ...
        private void AddValueChangeEvent(Object[] objects)
        {
            ...
            {
                AsScriptingHelper.AddToArray(ref _component.ValueChangeEvents, new AudioEventReference(evt.name));
            }
        }
        ...
        private void AddPopupEvent(Object[] objects)
        {
            ...
            foreach (var evt in events)
            {
                AsScriptingHelper.AddToArray(ref _component.PopupEvents, new AudioEventReference(evt.name));
            }
        }
        ...
        private void AddCloseEvent(Object[] objects)
        {
            ...
            foreach (var evt in events)
            {
                AsScriptingHelper.AddToArray(ref _component.CloseEvents, new AudioEventReference(evt.name));
            }
        }
