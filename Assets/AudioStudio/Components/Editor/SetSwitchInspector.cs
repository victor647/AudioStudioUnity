...
namespace AudioStudio.Editor
{
    ...
    public class SetSwitchInspector : AsComponentInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            AsGuiDrawer.DrawList(serializedObject.FindProperty("OffSwitches"), OffLabel(_component), AddOffSwitch);
        ...
        private void AddOnSwitch(Object[] objects)
        {
            ...
            {
                AsScriptingHelper.AddToArray(ref _component.OnSwitches, new SetSwitchReference(evt.name));
            }
        }
        ...
        private void AddOffSwitch(Object[] objects)
        {
            ...
            foreach (var evt in events)
            {
                AsScriptingHelper.AddToArray(ref _component.OffSwitches, new SetSwitchReference(evt.name));
            }
        }
