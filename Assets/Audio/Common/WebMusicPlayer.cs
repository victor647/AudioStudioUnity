	...
	public class WebMusicInstance
		{
			...
			public WebMusicInstance(MusicTrack track, float fadeInTime, float fadeOutTime)
			{
				...
				_interopA = new WebGLStreamingAudioSourceInterop(AudioAssetLoader.GetClipUrl(clipName, ObjectType.Music), go);
				...
				{
					_interopB = new WebGLStreamingAudioSourceInterop(AudioAssetLoader.GetClipUrl(clipName, ObjectType.Music), go);
