...
{   
    ...
    {        
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            AudioManager.DebugToProfiler(ProfilerMessageType.Component, ObjectType.ColliderSound, AudioAction.Activate, "OnTriggerEnter", gameObject.name, "Enter with " + other.gameObject.name);
        ...
        {
            if (!CompareAudioTag(other)) return;            
            AudioManager.DebugToProfiler(ProfilerMessageType.Component, ObjectType.ColliderSound, AudioAction.Deactivate, "OnTriggerExit", gameObject.name, "Exit from " + other.gameObject.name);
        ...
        private void OnCollisionEnter(Collision other)
        {
            ...
            AudioManager.DebugToProfiler(ProfilerMessageType.Component, ObjectType.ColliderSound, AudioAction.Activate, "OnCollisionEnter", gameObject.name, "Collider with " + other.gameObject.name);
        ...
        {
            if (!CompareAudioTag(other.collider)) return;
            AudioManager.DebugToProfiler(ProfilerMessageType.Component, ObjectType.ColliderSound, AudioAction.Deactivate, "OnCollisionExit", gameObject.name, "Exit from " + other.gameObject.name);              
            PostEvents(ExitEvents, GetEmitter(other.gameObject));           
        }
